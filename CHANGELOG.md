...
* Computing the axis date range from all tasks with dates instead of only visible grouped tasks, so the axis always renders even when all groups are collapse
